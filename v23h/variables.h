...
#define CHANNEL1_SETTING_OFFSET          8     //24 all used  9*16bit=9    used 18*16bit
#define CHANNEL2_SETTING_OFFSET          32    //24 all used  9*16bit      used 18*16bit 
#define TRIGGER_SETTING_OFFSET           56    //24 all used  8*16bit      used 10*16bit
#define OTHER_SETTING_OFFSET             80    //24 all used  9*16bit      used  8*16bit 
#define CURSOR_SETTING_OFFSET            104   //16 all used  6*16bit      used  6*16bit
...
#define INPUT_CALIBRATION_SETTING_OFFSET 176   //32 all used 14*32bit=28 
                                        //192 next

                                                //>0x0100    load default settings
#define SETTING_SECTOR_VERSION_HIGH  0x0100     // 0x0100    load default settings and RESET input calibration data & calibration set to ON
#define SETTING_SECTOR_VERSION_LOW   0x0006     //>0x0002    //nova verzia ma ma 2 na 708sector
...
extern const uint32 timebase_settings[33];
...
extern const SCREENTIMECALCDATA screen_time_calc_data[33];
...
extern const int8 *time_div_texts[33];
extern const int8 time_div_text_x_offsets[33];
