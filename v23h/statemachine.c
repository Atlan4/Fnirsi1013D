  ...
  if((xtouch <= 730) && (ytouch <= 44))//46
  {
    ...
    if(xtouch <= 80)
    {
      ...
      if(scopesettings.waveviewmode == 0)
      {
        ...
        display_copy_rect_from_screen(2, 46, 147, 233);//0  149
        ...
        display_copy_rect_to_screen(2, 46, 147, 233);//0  149
    ...
    if(havetouch)
    {
      ...
      if((xtouch >= 2) && (xtouch <= 149) && (ytouch >= 46) && (ytouch <= 279))
      {
        ...
        else if((ytouch >= 225) && (ytouch <= 278))
        {
          ...
          display_set_source_buffer(displaybuffer2);
          display_copy_rect_to_screen(2, 46, 149, 233);//149
      ...
      //Check on calibrating 15V text opened and OK touched
            ...
            //Calibration DONE, will Save input_calibration data do SDcart
            } 
    ...
    if(havetouch)
    {
      ...
      if((xtouch >= settings->menuxpos) && (xtouch <= settings->menuxpos + CH_MENU_WIDTH) && (ytouch >= CH_MENU_YPOS) && (ytouch <= CH_MENU_YPOS + CH_MENU_HEIGHT))
      {
        ...
        if((ytouch >= CH_MENU_YPOS + 16) && (ytouch <= CH_MENU_YPOS + 38))
        {
          ...
          //Check on 50mV
          if((xtouch >= settings->menuxpos + 174 ) && (xtouch <= settings->menuxpos + 228 ))//64
          {
            //Set voltperdiv 50mV
            ...
            if(scopesettings.runstate == 0) match_volt_per_div_settings(settings);
          ...
          //Check on 1V
          if((xtouch >= settings->menuxpos + 232 ) && (xtouch <= settings->menuxpos + 282 ))//64
          {
            //Set voltperdiv 1V
        ...
        else if((ytouch >= CH_MENU_YPOS + 142) && (ytouch <= CH_MENU_YPOS + 164))// && (scopesettings.waveviewmode == 0))
        {
          ...
          if((xtouch >= settings->menuxpos + 78) && (xtouch <= settings->menuxpos + 110) && (scopesettings.waveviewmode == 0))
          {
          ...
          else if((xtouch >= settings->menuxpos + 130) && (xtouch <= settings->menuxpos + 162) && (scopesettings.waveviewmode == 0))
          {
        ...
        {
          //Check on 1x
          if((xtouch >= settings->menuxpos + 78) && (xtouch <= settings->menuxpos + 98)&& (scopesettings.waveviewmode == 0))
          {
            //Enable the channel
          ...
          //Check on 10x
          else if((xtouch >= settings->menuxpos + 109) && (xtouch <= settings->menuxpos + 132)&& (scopesettings.waveviewmode == 0))
          {
            //Disable the channel
          ...
          //Check on 100x
          else if((xtouch >= settings->menuxpos + 138) && (xtouch <= settings->menuxpos + 168)&& (scopesettings.waveviewmode == 0))
          {
            //Disable the channel
          ...
          if((xtouch >= settings->menuxpos + 232 ) && (xtouch <= settings->menuxpos + 282 ))//64
            {
            //Check if channel is 1 (0) or 2 (1) and trigger channel 1 or channel 2
            if(((scopesettings.triggerchannel == 0) && (settings->color == YELLOW_COLOR ))
               ||((scopesettings.triggerchannel == 1) && (settings->color == BLUE_COLOR )))
                {
...
void handle_right_volts_div_menu_touch(void)
{
  ...
  if((ytouch >= 93) && (ytouch <= 155))//78 - 140
  {
    ...
    if(scopesettings.channel1.enable)
    {
      ...
      if(scopesettings.channel1.displayvoltperdiv < 6)
      {
        ...
        //For waveform view mode the stop state is forced and can't be changed
        if(scopesettings.runstate == 0) match_volt_per_div_settings(&scopesettings.channel1);
      }
    }
  }
  //Check if channel 1 V- button is touched
  ...
  else if((ytouch >= 258) && (ytouch <= 320))
  {
    ...
    if(scopesettings.channel2.enable)
    {
      ...
      if(scopesettings.channel2.displayvoltperdiv < 6)
      {
        ...
        //Only update the FPGA in run mode
        //For waveform view mode the stop state is forced and can't be changed
        if(scopesettings.runstate == 0) match_volt_per_div_settings(&scopesettings.channel2);  
      }
    }
  }
  //Check if channel 2 V- button is touched
  ...
  else if((ytouch >= 258) && (ytouch <= 320))
  {
    ...
    if (scopesettings.channel1.dcoffset<220) scopesettings.channel1.dcoffset+=4; 
    //Wait until touch is released
    tp_i2c_wait_for_touch_release();
...
void move_trigger_point_position(void)
{
  ...
  //Long time base & no auto mode - set other values and clear view area
...
void change_channel_1_offset(void)
{
  ...
  //Write it to the FPGA
  fpga_set_channel_offset(&scopesettings.channel1); //softverovy posun, toto je zbytocne
...
void change_channel_2_offset(void)
{
  ...
  //Write it to the FPGA
  fpga_set_channel_offset(&scopesettings.channel2); //softverovy posun, toto je zbytocne
