...
#define CHANNEL1_SETTING_OFFSET          8     //24 all, used  9*16bit=9    used 19*16bit
#define CHANNEL2_SETTING_OFFSET          32    //24 all, used  9*16bit      used 19*16bit 
#define TRIGGER_SETTING_OFFSET           56    //24 all, used  8*16bit      used 10*16bit
#define OTHER_SETTING_OFFSET             80    //24 all, used 10*16bit      used  8*16bit 
...
#define SETTING_SECTOR_VERSION_LOW   0x000E     //>0x0002    //nova verzia ma ma 2 na 709 sector
...
extern const int8 volt_div_texts_x_offsets[49];//21
